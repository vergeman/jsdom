...
const CSSStyleSheet = require("../generated/CSSStyleSheet.js");
...
exports.forEachMatchingSheetRuleOfElement = (elementImpl, handleRule) => {
  ...
  if (!parsedDefaultStyleSheet) {
    parsedDefaultStyleSheet = CSSStyleSheet.createImpl(
      elementImpl._globalObject,
      [
        {
          baseURL: null,
          media: elementImpl.getAttributeNS(null, "media"),
          disabled: elementImpl.getAttributeNS(null, "disabled")
        }
      ],
      { sheetText: defaultStyleSheet, elementImpl }
    );
  }
